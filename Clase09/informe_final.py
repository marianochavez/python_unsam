...
def leer_camion(nombre_archivo):
    """Lee un archivo csv y lo convierte en una lista, luego lo transforma en una lista
    con objetos de tipo Lote"""
    camion_dicts = fileparse.parse_csv(open(nombre_archivo), types=[str, int, float], has_headers=True)
